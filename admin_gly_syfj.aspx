<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_gly_syfj.aspx.cs" Inherits="admin_gly" %>
	...
	<form id="form1" runat="server">
		<div>
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
				SelectCommand="SELECT [ID], [GLYXM], [SYSID], [GLYID], [SYSMC], [SYSDD] FROM [V_SYSGLY]"
			...
			<asp:SqlDataSource ID="GLYSDS" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>" SelectCommand="SELECT [DLM], [GLYXM] FROM [T_GLYXXB] WHERE ([GLYLX] = @GLYLX) ORDER BY [GLYXM]">
				<SelectParameters>
			...
			<asp:SqlDataSource ID="SYSSDS" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
				SelectCommand="SELECT [ID], [LXMC] FROM [D_SYSLXB]">
			</asp:SqlDataSource>
			<asp:SqlDataSource ID="SYFJSDS" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
				SelectCommand="SELECT [ID], [SYSMC], [SYSLXID] FROM [T_SYSXXB] WHERE ([SYSLXID] = @SYSLXID)">
				<SelectParameters>
					<asp:ControlParameter ControlID="SYSDDL" Name="SYSLXID" PropertyName="SelectedValue"
						Type="Int32" />
				</SelectParameters>
			</asp:SqlDataSource>
		</div>
				...
				&nbsp;<table>
					<tr>
						...
						<td style="width: 147px">
							<asp:DropDownList ID="GLYDDL" runat="server" Width="130px" DataSourceID="GLYSDS" DataTextField="GLYXM" DataValueField="DLM">
							</asp:DropDownList></td>
					</tr>
					<tr>
						<td align="right" style="width: 100px">
							选择实验室：</td>
						<td style="width: 147px">
							<asp:DropDownList ID="SYSDDL" runat="server"  Width="130px" DataTextField="LXMC" DataValueField="ID" DataSourceID="SYSSDS" OnSelectedIndexChanged="SYSDDL_SelectedIndexChanged" AutoPostBack="True">
							</asp:DropDownList></td>
					</tr>
					<tr>
						<td align="right" style="width: 100px">
							选择实验房间：</td>
						<td style="width: 147px">
							<asp:DropDownList ID="SYFJDDL" runat="server"  Width="130px" DataTextField="SYSMC" DataValueField="ID" DataSourceID="SYFJSDS">
							</asp:DropDownList></td>
					</tr>
					<tr valign="bottom">
