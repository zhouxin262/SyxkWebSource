<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin_sy_lb.aspx.cs" Inherits="admin_sy_lb" %>
...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
            DeleteCommand="DELETE FROM [D_SYLBB] WHERE [ID] = @ID" InsertCommand="INSERT INTO [D_SYLBB] ([LBMC]) VALUES (@LBMC)"
            SelectCommand="SELECT * FROM [D_SYLBB]" UpdateCommand="UPDATE [D_SYLBB] SET [LBMC] = @LBMC WHERE [ID] = @ID">
            <DeleteParameters>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DataSourceID="SqlDataSource1" DefaultMode="Insert">
            <InsertItemTemplate>
                ...
                <asp:Button ID="Button2" runat="server" CommandName="cancle" Text="取消" /><br />
                &nbsp; &nbsp;
            </InsertItemTemplate>
        </asp:FormView></div>
    </form>
