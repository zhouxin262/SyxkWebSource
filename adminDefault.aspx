...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="js/adminMain.js" charset="GB2312"></script>
	          ...
	          <tr>
			        ...
			        <td id="left" class="left_border">
				        <div id="left_toolbar" class="toolbarBg">
                            ...
                            <a href="adminlogout.aspx"  onclick="return confirm('确认退出系统？');">退出系统</a>				</div>
				        <!-- 左侧导航菜单开始 -->
				        <div id="menuWarp">
