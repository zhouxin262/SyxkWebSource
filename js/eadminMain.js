...
init = function() {
	...
	Menus = {
		...
		"实验信息管理" :	{"row" : 1, "show" : true, "menu" : {"实验信息添加" : "eadm_sy_tj.aspx", "实验信息编辑" : "eadm_sy_bj.aspx", "实践项目审批":"eadm_sjxm_lb.aspx", "自主项目审批":"eadm_zzxm_lb.aspx"}},
		"实验计划管理" :	{"row" : 1, "show" : true, "menu" : { "实验计划课表":"eadm_syjh_bg.aspx","实验计划生成" : "eadm_syjh_sc.aspx", "实验计划编辑" : "eadm_syjh_bj.aspx" }},
		"实验人员管理" :    {"row" : 1, "show" : true, "menu" : {"实验人员编辑" : "eadm_syrj_bj.aspx", "实验评分导入":"eadm_sypfdr.aspx","未选实验学生":"eadm_wxsyxsmd.aspx" ,"实验签到情况":"eadm_syqdqk.aspx"}},
		"个人信息管理" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "eadm_xgmm.aspx", "修改个人信息" : "admin_xggrxx.aspx"}}
