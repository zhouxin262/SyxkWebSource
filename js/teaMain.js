...
init = function() {
	...
	// 初始化菜单列表
	Menus = {
		"实验课程管理" :	{"row" : 1, "show" : true, "menu" : {"实践项目申请" : "tea_sjxm_sq.aspx", "实践项目列表" : "tea_sjxm_lb.aspx", "实验计划列表" : "tea_syap_lb.aspx"}},
		
		"个人信息管理" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "tea_xgmm.aspx", "修改个人信息" : "tea_xggrxx.aspx"}}
