...
init = function() {
	...
	// 初始化菜单列表
	Menus = {
		"基础信息管理" :	{"row" : 1, "show" : true, "menu" : {"学生类别维护" : "admin_xs_lb.aspx", "教师类别维护" : "admin_js_lb.aspx", "学院信息维护" : "admin_xy_xx.aspx", "专业信息维护" : "admin_zy_xx.aspx","发布 通知":"admin_tongzhi_tj.aspx"}},
		"系统信息管理" :	{"row" : 1, "show" : true, "menu" : {"管理员信息维护" : "admin_gly.aspx","实验类别维护" : "admin_sy_lb.aspx", "实验类型维护" : "admin_sy_lx.aspx", "实验要求维护" : "admin_sy_yq.aspx",  "设定学期起始日期" : "admin_xqqsrq.aspx"}},

		"实验房间管理" :	{"row" : 1, "show" : true, "menu" : {"实验室维护" : "admin_sys_lx.aspx","实验房间添加" : "admin_sys_tj.aspx", "实验房间编辑" : "admin_sys_bj.aspx","实验房间管理设置" : "admin_gly_syfj.aspx", "实验房间课程设置" : "admin_sys_kc.aspx"}},
		
		"课程实验维护" :	{"row" : 1, "show" : true, "menu" : {"实验计划导入":"eadm_syapdr.aspx","课程信息添加" : "aadm_kcxx_tj.aspx", "课程信息编辑" : "aadm_kcxx_bj.aspx", "选课人员导入":"eadm_xkxsdr.aspx"}},
		"学生信息维护" :	{"row" : 1, "show" : true, "menu" : {"学生信息导入" : "aadm_xsxxdr.aspx", "学生信息添加" : "aadm_xsxx_tj.aspx", "学生信息编辑" : "aadm_xsxx_bj.aspx"}},
		"教师信息维护" :	{"row" : 1, "show" : true, "menu" : {"教师信息导入" : "aadm_jsxx_dr.aspx", "教师信息添加" : "aadm_jsxx_tj.aspx", "教师信息编辑" : "aadm_jsxx_bj.aspx"}},
		"个人信息管理" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "admin_xgmm.aspx", "修改个人信息" : "admin_xggrxx.aspx"}}
