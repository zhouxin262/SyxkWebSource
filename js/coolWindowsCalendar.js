...
document.writeln('<iframe id=meizzDateLayer Author=wayx frameborder=0 style="position: absolute; width: 105; height: 55; z-index: 9998; display: none"></iframe>'); 
strFrame='<style>'; 
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=42 height=60 bordercolor=#ff9900 bgcolor=#ff9900 Author="wayx">'; 
