...
init = function() {
	...
	// 初始化菜单列表
	Menus = {
		"课程实验管理" :	{"row" : 1, "show" : true, "menu" : {"实验计划申请" : "stu_sykc_sq.aspx", "实验计划列表" : "stu_sykc_lb.aspx","实验课课程表":"stu_syjh_bg.aspx" ,"查看实验分数":"stu_syfs_lb.aspx"}},
		"自主实践项目" :	{"row" : 1, "show" : true, "menu" : {"自主实践项目申请" : "stu_zjsjxm_sq.aspx", "自主实践项目列表" : "stu_zjsjxm_lb.aspx"}},
		"个人信息管理" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "stu_xgmm.aspx", "修改个人信息" : "stu_xggrxx.aspx"}}
	};
	// 生成并初始化菜单
	menu.create(Menus);
	menu.show("menu_1");
