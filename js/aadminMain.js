...
init = function() {
	...
	// 初始化菜单列表
	Menus = {
		"课程信息维护" :	{"row" : 1, "show" : true, "menu" : {"课程信息添加" : "aadm_kcxx_tj.aspx", "课程信息编辑" : "aadm_kcxx_bj.aspx"}},
		"学生信息维护" :	{"row" : 1, "show" : true, "menu" : {"学生信息导入" : "aadm_xsxx_dr.aspx", "学生信息添加" : "aadm_xsxx_tj.aspx", "学生信息编辑" : "aadm_xsxx_bj.aspx"}},
		"教师信息维护" :	{"row" : 1, "show" : true, "menu" : {"教师信息导入" : "aadm_jsxx_dr.aspx", "教师信息添加" : "aadm_jsxx_tj.aspx", "教师信息编辑" : "aadm_jsxx_bj.aspx"}},
		"个人信息管理" :	{"row" : 1, "show" : true, "menu" : {"修改密码" : "aadm_xgmm.aspx", "修改个人信息" : "admin_xggrxx.aspx"}}
