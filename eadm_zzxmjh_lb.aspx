<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eadm_zzxmjh_lb.aspx.cs" Inherits="eadm_zzxmjh_lb" %>
...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
            SelectCommand="SELECT [ID],[SYBH], [SYID], [SYJSID], [JSXM], [SYSID], [SYXN], [SYRS], [SYKS], [SYSDD], [SYZ], [SYXQ], [XSXM], [SQRID], [SYJJ], [SYXS], [SYMC], [SYXINGQ], [XYMC], [SJH], [YJDZ], [LBMC], [XYID], [ZYID], [ZYMC], [XSLBID],[XINGQIMC],[ZMC],[MC],[KSSJ],[JSSJ] FROM [V_ZZSJXMJHB] ORDER BY [SYBH]"
            ...
            <asp:Parameter Name="SYJSID" Type="Int32" />
        ...
        <asp:SqlDataSource ID="JSSDS" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
            SelectCommand="SELECT [GZH], [JSXM] FROM [T_JSXXB] WHERE (([JSLB] = @JSLB) AND ([SFYX] = @SFYX)) OR (GZH='0000') order by jsxm">
            <SelectParameters>
