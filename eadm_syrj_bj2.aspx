<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eadm_syrj_bj2.aspx.cs" Inherits="eadm_syrj_bj2" %>
...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
            SelectCommand="SELECT [ID], [SYBH], [SYMC], [KCMC], [JSXM], [SYSDD], [XSLB], [SYZLBID], [SYRS], [ZMC], [XINGQMC], [SYXN], [SYXQ], [MC] FROM [V_SYJHXXB] WHERE ([ID] = @ID)">
            <SelectParameters>
                <asp:QueryStringParameter Name="ID" QueryStringField="ID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:syxkConn %>"
            SelectCommand="SELECT [JRSJ],[LKSJ],[ID],[SHR], [XSXH], [XSXM], [XYID], [ZYID], [XSLBID], [SJH], [YJDZ], [ZYMC], [LBMC], [XYMC] FROM [V_SYXKB] WHERE ([SYJHID] = @SYJHID)"
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White"
            ...
            <Fields>
                ...
                <asp:BoundField DataField="KCMC" HeaderText="课程" SortExpression="KCMC" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
               ...
               <asp:BoundField DataField="JRSJ" HeaderText="登记时间" SortExpression="JRSJ" />
        ...
        <asp:Button ID="Button3" runat="server" Text="导出学生列表" OnClick="Button3_Click" /></div>
    </form>
</body>
</html>
