<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="aadmDefault.aspx.cs" Inherits="aadmDefault" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="js/aadminMain.js" charset=GB2312></script>
	        ...
	        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #95B6CE;">
	          <tr>
			        ...
			        <td id="main" class="main_border">
				        ...
				        <div id="footer" class="toolbarBg"><span class="left"> 2010版权所有.</span></div>
			        </td>
		        </tr>
	        </table>
        </div>
